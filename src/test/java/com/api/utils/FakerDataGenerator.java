...
public class FakerDataGenerator {
	...
	private static CustomerProduct generateFakeCustomerProduct() {
		...
		return new CustomerProduct(serialNumber, serialNumber, serialNumber, dop, popUrl, PRODUCT_ID, MODEL_ID);
	}
	...
	private static CustomerAddress generateFakeCustomerAddress() {
		...
		return new CustomerAddress(flatNumber, apartmentName, streetName, landmark, area, pincode, state, COUNTRY);
	}
