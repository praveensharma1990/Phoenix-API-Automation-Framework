...
public class CreateJobApiDBValidationTest {
	...
	public void setup() {
		...
		CustomerProduct customerProduct = new CustomerProduct("23456781801744", "23456781801744", "23456781801744",
	...
	public void createJobApiTest() {
	 Response response = given().spec(requestSpecWithAuth(UserRole.FD, payload)).when().post("/job/create").then().log()
		...
		CustomerAddressDBModel actualCustomerAddress = CustomerAddressDao.getCustomerAddressData(customerDataFromDb.getTr_customer_address_id());
		...
		Assert.assertEquals(customerProductExpected.dop(), customerProductActual.getDop());
