...
public class CreateJobApiDBlDataDrivenTest {
	private JobService jobService;
	
	@BeforeMethod(description = "Instanciate Job Service")
	public void setup() {
		jobService = new JobService();
	}
		
	@Test(description = "validate create job api response is correct for inwarranty", groups = { "dataDriven",
			"regression","DB" }, dataProviderClass = com.dataproviders.DataProviderUtils.class, dataProvider="createJobApiDBDataprovider")
